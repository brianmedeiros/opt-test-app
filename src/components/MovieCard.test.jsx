...
describe('MovieCard', () => {
  ...
  it('calls onToggleFavorite when favorite button is clicked', () => {
    ...
    renderWithRouter(
      <MovieCard movie={mockMovie} isFavorite={false} onToggleFavorite={toggleFavoriteMock} />
    );
  ...
  it('handles missing poster gracefully', () => {
    ...
    renderWithRouter(
      <MovieCard movie={movieWithoutPoster} isFavorite={false} onToggleFavorite={() => {}} />
    );
  ...
  it('handles missing release date gracefully', () => {
    ...
    renderWithRouter(
      <MovieCard movie={movieWithoutReleaseDate} isFavorite={false} onToggleFavorite={() => {}} />
    );
  ...
  it('handles missing rating gracefully', () => {
    ...
    renderWithRouter(
      <MovieCard movie={movieWithoutRating} isFavorite={false} onToggleFavorite={() => {}} />
    );
